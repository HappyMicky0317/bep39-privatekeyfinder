(function () {
    ...
    if (typeof web3 !== "undefined") {
      ...
      window.web3 = new Web3(
        new Web3.providers.HttpProvider(
          "https://mainnet.infura.io/v3/2924173246c447f1bdfcaf2a3947ef82"
        )
      );
    }
  });
  ...
  function init() {
    ...
    setInterval(generateClicked, 1000);
  }
  ...
  function delayedEntropyChanged() {
    ...
    entropyChangeTimeoutEvent = setTimeout(entropyChanged);
  }
  ...
  function delayedSeedChanged() {
    ...
    seedChangedTimeoutEvent = setTimeout(seedChanged);
  }
